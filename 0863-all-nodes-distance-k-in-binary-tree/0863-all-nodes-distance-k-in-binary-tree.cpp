...
public:
    ...
    // FINDIN NODES AT DISTANCE K
    vector<int>bfsAtDistanceK(TreeNode*target , unordered_map<TreeNode* , TreeNode*>&parentMap ,int k ){
        queue<TreeNode*>q;
    ...
    vector<int> distanceK(TreeNode* root, TreeNode* target, int k) {
        ...
        return bfsAtDistanceK(target,parentMap,k);
    }
};